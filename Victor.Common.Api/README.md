...
Common API utilities and middleware for ASP.NET Core applications in the Victor framework.
...
```xml
<ItemGroup>
  <ProjectReference Include="..\..\common\Victor.Common.Api\Victor.Common.Api.csproj" />
</ItemGroup>
```
...
Internal use only - Victor Framework
