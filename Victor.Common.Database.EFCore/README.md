# Victor.Common.Database.EFCore

Entity Framework Core implementation of the Victor database abstractions.

## Overview

This library provides EF Core implementations of the repository pattern and Unit of Work pattern defined in `Victor.Common.Database`. It supports both single database and separate read/write database configurations.
...
```xml
<ProjectReference Include="..\Victor.Common.Database.EFCore\Victor.Common.Database.EFCore.csproj" />
```
...
- **Requirement 1.5**: Victor.Common.Database.EFCore library for EF Core implementations
...
- Victor.Common.Database (project reference)
