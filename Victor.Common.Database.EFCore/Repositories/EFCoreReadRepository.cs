...
using Victor.Common.Database.EFCore.Extensions;
using Victor.Common.Database.EFCore.Specifications;
using Victor.Common.Domain.Specifications;

namespace Victor.Common.Database.EFCore.Repositories;
