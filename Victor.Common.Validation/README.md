...
- **Reusable Across Microservices**: Designed to be shared across all services in the Victor architecture

## Installation

Add a project reference to `Victor.Common.Validation` in your application project:

```xml
<ItemGroup>
  <ProjectReference Include="..\..\common\Victor.Common.Validation\Victor.Common.Validation.csproj" />
</ItemGroup>
```
...
```csharp
using Victor.Common.Validation.Extensions;
...
This integrates seamlessly with RFC 7807 Problem Details responses when used with `Victor.Common.Api`.
...
This library is part of the Victor project structure and follows the same licensing terms as the parent project.
