...
using Victor.Common.Observability.Configuration;

namespace Victor.Common.Observability.Extensions;
...
public static class ObservabilityExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddVictorObservability(
    ...
    /// </summary>
    public static IApplicationBuilder UseVictorPrometheus(this IApplicationBuilder app)
    {
    ...
    /// </summary>
    public static IApplicationBuilder UseVictorPrometheus(
