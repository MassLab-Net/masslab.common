namespace Victor.Common.Messaging.Kafka.Configuration;
...
public class KafkaOptions
{
    ...
    public string Topic { get; set; } = "victor.events";

    /// <summary>Consumer group id (default <c>victor-consumer</c>).</summary>
    public string GroupId { get; set; } = "victor-consumer";
