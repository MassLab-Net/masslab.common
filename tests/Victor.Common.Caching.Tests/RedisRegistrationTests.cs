...
{
    [Fact]
    public void AddVictorRedisCache_WithConfiguration_RegistersRedisServicesWithoutConnecting()
    {
        ...
        services.AddVictorRedisCache(configuration);
    ...
    [Fact]
    public void AddVictorRedisCache_WithMissingConnectionString_ThrowsConfigurationException()
    {
        var services = new ServiceCollection();

        var act = () => services.AddVictorRedisCache(_ => { });
    ...
    [InlineData(0)]
    [InlineData(-1)]
    public void AddVictorRedisCache_WithInvalidConnectTimeout_ThrowsConfigurationException(int seconds)
    {
        var services = new ServiceCollection();

        var act = () => services.AddVictorRedisCache(options =>
        {
    ...
    [InlineData(0)]
    [InlineData(-1)]
    public void AddVictorRedisCache_WithInvalidOperationTimeout_ThrowsConfigurationException(int seconds)
    {
        var services = new ServiceCollection();
