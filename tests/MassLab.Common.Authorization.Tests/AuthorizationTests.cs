...
namespace MassLab.Common.Authorization.Tests;
...
public class AuthorizationTests
{
    ...
    [Fact]
    public async Task MassLab_authorization_replaces_default_policy_provider_registered_earlier()
    {
        var services = new ServiceCollection();
        services.AddLogging();
        services.AddAuthorization();
        services.AddMassLabAuthorization();
