...
namespace Victor.Common.Observability.Tests;
...
public class ObservabilityTests
{
    ...
    public void Options_expose_expected_defaults()
    {
        ...
        options.ServiceName.Should().Be("victor-service");
    ...
    public void Registration_accepts_disabled_tracing_and_metrics()
    {
        ...
        services.AddVictorObservability(configureOptions: o =>
        {
    ...
    public void Registration_rejects_invalid_otlp_endpoint()
    {
        ...
        var act = () => services.AddVictorObservability(configureOptions: o =>
        {
