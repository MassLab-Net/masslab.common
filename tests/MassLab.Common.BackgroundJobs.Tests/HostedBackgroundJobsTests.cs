...
using MassLab.Common.BackgroundJobs.Hosted;
using MassLab.Common.BackgroundJobs.Hosted.Extensions;

namespace MassLab.Common.BackgroundJobs.Tests;
...
public class HostedBackgroundJobsTests
{
    ...
    public async Task Hosted_scheduler_executes_enqueued_jobs()
    {
        ...
        services.AddMassLabHostedBackgroundJobs();
    ...
    public void Hosted_provider_respects_run_worker_false()
    {
        ...
        services.AddMassLabHostedBackgroundJobs(configuration);
