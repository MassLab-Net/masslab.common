...
using Victor.Common.HttpClient.Extensions;
using Victor.Common.HttpClient.Handlers;
using Victor.Common.HttpClient.Policies;

namespace Victor.Common.HttpClient.Tests;
