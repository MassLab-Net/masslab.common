...
SQL Server database provider package for Dapper in the Victor.Common.Database ecosystem.

## Overview

This package provides SQL Server-specific implementations for Dapper, enabling applications to use SQL Server databases with the Victor.Common.Database repository pattern and unit of work abstractions using Dapper's lightweight micro-ORM approach.
...
```bash
dotnet add package Victor.Common.Database.Dapper.SqlServer
```
