...
MySQL database provider package for Dapper in the Victor.Common.Database ecosystem.

## Overview

This package provides MySQL-specific implementations for Dapper, enabling applications to use MySQL databases with the Victor.Common.Database repository pattern and unit of work abstractions using Dapper's lightweight micro-ORM approach.
...
```bash
dotnet add package Victor.Common.Database.Dapper.MySQL
```
