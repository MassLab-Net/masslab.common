namespace Victor.Common.Messaging.RabbitMQ.Configuration;
...
public class RabbitMqOptions
{
    ...
    /// <summary>Topic exchange name (default <c>victor.events</c>).</summary>
    public string ExchangeName { get; set; } = "victor.events";

    /// <summary>Queue name for inbound subscriptions (default <c>victor.queue</c>).</summary>
    public string QueueName { get; set; } = "victor.queue";
