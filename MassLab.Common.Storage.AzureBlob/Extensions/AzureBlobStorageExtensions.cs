...
using MassLab.Common.Storage.AzureBlob.Configuration;
using MassLab.Common.Storage.AzureBlob.Services;

namespace MassLab.Common.Storage.AzureBlob.Extensions;
