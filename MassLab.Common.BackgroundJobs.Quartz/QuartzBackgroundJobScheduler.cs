...
/// of execution is <see cref="MassLabJobAdapter{TJob,TPayload}"/>; this
...
public class QuartzBackgroundJobScheduler : IBackgroundJobScheduler
{
    ...
    internal const string PayloadKey = "__masslab_payload";
    internal const string PayloadTypeKey = "__masslab_payload_type";
    internal const string RecurringGroup = "masslab-recurring";
        ...
        where TJob : IBackgroundJob<TPayload>
    {
        ...
        var adapterType = isConcurrent
            ? typeof(ConcurrentMassLabJobAdapter<,>).MakeGenericType(typeof(TJob), typeof(TPayload)!)
            : typeof(MassLabJobAdapter<,>).MakeGenericType(typeof(TJob), typeof(TPayload)!);
