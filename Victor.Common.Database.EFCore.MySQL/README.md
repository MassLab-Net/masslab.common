...
MySQL database provider package for Entity Framework Core in the Victor.Common.Database ecosystem.

## Overview

This package provides MySQL-specific implementations for Entity Framework Core, enabling applications to use MySQL databases with the Victor.Common.Database repository pattern and unit of work abstractions.
...
```bash
dotnet add package Victor.Common.Database.EFCore.MySQL
```
...
```csharp
using Victor.Common.Database.EFCore.MySQL.Extensions;
