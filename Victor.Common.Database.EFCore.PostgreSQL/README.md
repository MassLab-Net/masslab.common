...
PostgreSQL database provider package for Entity Framework Core in the Victor.Common.Database ecosystem.

## Overview

This package provides PostgreSQL-specific implementations for Entity Framework Core, enabling applications to use PostgreSQL databases with the Victor.Common.Database repository pattern and unit of work abstractions.
...
```bash
dotnet add package Victor.Common.Database.EFCore.PostgreSQL
```
...
```csharp
using Victor.Common.Database.EFCore.PostgreSQL.Extensions;
