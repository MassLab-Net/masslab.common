# Victor.Common.Caching

Base abstractions package for the Victor.Common caching system, providing unified interfaces for both in-memory and distributed Redis caching.

## Overview

Victor.Common.Caching defines the core contracts and models for cache operations, enabling developers to write cache-agnostic code that works seamlessly with any provider implementation. This package contains only interfaces and abstractions with no provider-specific dependencies.

## Architecture

The caching system follows a three-package architecture:

- **Victor.Common.Caching** (this package): Base abstractions and interfaces
- **Victor.Common.Caching.Memory**: In-memory caching implementation
- **Victor.Common.Caching.Redis**: Distributed Redis caching implementation
...
See [Victor.Common.Caching.Memory README](../Victor.Common.Caching.Memory/README.md) for configuration and usage.

### Redis Cache

```bash
dotnet add package Victor.Common.Caching.Redis
```

See [Victor.Common.Caching.Redis README](../Victor.Common.Caching.Redis/README.md) for configuration and usage.
