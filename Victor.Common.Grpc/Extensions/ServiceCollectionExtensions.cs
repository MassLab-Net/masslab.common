...
namespace Victor.Common.Grpc.Extensions;
...
public static class ServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddVictorGrpcReflection(this IServiceCollection services)
    {
    ...
    /// </summary>
    public static IServiceCollection AddVictorGrpcHealthChecks(this IServiceCollection services)
    {
...
public static class GrpcEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointRouteBuilder MapVictorGrpcReflection(this IEndpointRouteBuilder endpoints)
    {
    ...
    public static IEndpointRouteBuilder MapVictorGrpcHealthChecks(this IEndpointRouteBuilder endpoints)
    {
