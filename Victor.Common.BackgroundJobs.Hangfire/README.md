# Victor.Common.BackgroundJobs.Hangfire

Hangfire provider for `Victor.Common.BackgroundJobs`.
...
builder.Services.AddVictorHangfire(builder.Configuration);
...
{
  "BackgroundJobs": {
    "StorageConnectionString": "Host=localhost;Database=victor_jobs;Username=postgres;Password=postgres"
  }
}
```
