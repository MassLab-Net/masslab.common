...
namespace Victor.Common.Caching.Memory;
...
public class MemoryCacheService : ICacheService
{
    ...
    private readonly Configuration.VictorMemoryCacheOptions _options;

    public MemoryCacheService(IMemoryCache cache, IOptions<Configuration.VictorMemoryCacheOptions> options)
    {
