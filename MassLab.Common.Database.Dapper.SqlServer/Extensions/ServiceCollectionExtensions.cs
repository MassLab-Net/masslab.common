...
using MassLab.Common.Database.Dapper.SqlServer.Factories;
using MassLab.Common.Database.Dapper.Repositories;
using MassLab.Common.Database.Dapper.UnitOfWork;

namespace MassLab.Common.Database.Dapper.SqlServer.Extensions;

/// <summary>
/// Extension methods for registering SQL Server database services with Dapper.
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Registers SQL Server Dapper services including connection factory, repositories, and unit of work.
    /// </summary>
    ...
    public static IServiceCollection AddSqlServerDapper(
        ...
        string configurationSection = "Database")
    {
        ...
        // Register SQL Server ConnectionFactory
