...
using MassLab.Common.Messaging.Dispatch;

namespace MassLab.Common.Messaging.Extensions;
...
public static class MessagingServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddMassLabMessagingCore(this IServiceCollection services)
    {
